...
- Canvas principal concentrado em [`apps/web/src/app/features/canvas/canvas-board.component.ts`](../apps/web/src/app/features/canvas/canvas-board.component.ts) com ~2669 linhas.
